...
public class ParallelArray {
    ...
    void print() { // todo: should method be synchronized or not - no difference
    ...
    /**
     * and add to parArray int nextNum converted from String num getted from Scanner in
     * @return nextNum
     */
    public String takeNum() {
        ...
        synchronized (this.numsArray) {
            this.numsArray.add(this.inNumerals(nextNum));
        }
